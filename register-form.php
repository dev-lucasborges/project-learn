                ...
                <div class="m-4 my-5">
                    ...
                    ?>
                        <form action="cadastrar.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input type="number" name="nome" name="text" class="mb-2 form-control" placeholder="Matricula" required>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                            ...
                            <p class="text-muted">Já tem uma conta ?<a href="login-form.php"class="text-primary"> clique aqui</a></p>
                            <button type="submit" class="btn btn-primary gobtn">Registrar</button>
                        </form>
                    </div>
                </div>
            </div>
